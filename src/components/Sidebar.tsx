      ...
      <div className="flex-1 overflow-y-auto">
        {filteredRequests.length === 0 ? (
          <div className="p-3 sm:p-4 text-center text-gray-500">
            <div className="mb-2">
              {activeSection === 'history' ? (
                <Clock className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-gray-300" />
              ) : (
                <Save className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-gray-300" />
              )}
            </div>
            <p className="text-sm">
              {searchTerm
          ...
          <div className="p-1 sm:p-2 space-y-1">
            {filteredRequests.map((request) => (
              <div
                ...
                className="group p-2 sm:p-3 hover:bg-white rounded-lg cursor-pointer transition-colors border border-transparent hover:border-gray-200 hover:shadow-sm"
              >
